...
exports.handlers = {
  ...
  "181a": function (a) { // ATC_MiThermometer
    if (a.length === 15) { // pvvx
      let voltage = a.readInt16LE(10);
      return {
        temp: a.readInt16LE(6) / 100,
      ...
      return {
        temp: a.readInt16BE(6) / 10,
        humidity: a.readUInt8(8),
        battery: a.readUInt8(9),
        battery_voltage: a.readInt16BE(10) / 1000,
        type: "ATC (ATC1441)"
      }
    } else if (a.length === 8 || a.length === 11 ) {
      // @todo https://github.com/pvvx/ble_monitor/blob/1dbca595d469b63963bae69ff70685c7a2d90944/custom_components/ble_monitor/ble_parser/atc.py
      return {
        type: "PVVX/ATC (encryption)"
      }
    }
  },
