...
exports.init = function() {
  ...
  if (require("fs").existsSync(pathToWWW)) {
    log("`www` directory found. Not serving at http://localhost:"+httpPort);
  } else {
  ...
  try {
    ...
    log("espruino-web-ide module not found. Not serving IDE");
    pathToWebIDE = undefined;
  }    

  if (pathToWebIDE) {
    log("espruino-web-ide found at "+pathToWebIDE);
    log("Serving Web IDE on http://localhost:"+httpPort+"/ide");
  }    
}
